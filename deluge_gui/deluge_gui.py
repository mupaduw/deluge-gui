...
def main_window():
    ...
    #OLD SKOOL TABS
    # mainframe = [sg.Frame('Mainframe', layout=[[sg.TabGroup([[
    ...
    mline_col = sg.Col([[]])
    # sg.Multiline(size=(100, 46), key='-ML-', write_only=True, reroute_stdout=True, font='Courier 10', expand_x=True, expand_y=True)],
    #                     [sg.T(size=(80, 1), font='Courier 10 underline', k='-DOC LINK-', enable_events=True)]], pad=(0, 0), expand_x=True, expand_y=True, vertical_alignment='t')
    ...
    window = sg.Window(APP_NAME, layout, resizable=True, finalize=True,
        enable_close_attempted_event=True,  location=location)
